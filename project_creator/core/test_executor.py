...
class TestExecutor:
    ...
    def detect_test_framework(self):
        ...
        if os.path.exists(os.path.join(self.project_root, "pytest.ini")) or os.path.exists(os.path.join(self.project_root, "conftest.py")):
            return "pytest"
    ...
    def generate_repair_context(self, res):
        ...
        return {
            ...
            "failure_type": self.classify_failure(res.get('stderr', '') + res.get('stdout', ''))
        }
