...
class TaskGenerator:
    def __init__(self, router):
        self.router = router
        self.topics = ["FastAPI", "Streamlit", "CLI", "RAG", "Scraper", "Unit Testing", "Refactoring", "Bug fixing"]

    def generate_task(self):
        topic = random.choice(self.topics)
        difficulty = random.choice(["Junior", "Mid", "Senior"])

        system_prompt = "You are a senior engineering manager. Generate a synthetic coding task."
        prompt = f"""
